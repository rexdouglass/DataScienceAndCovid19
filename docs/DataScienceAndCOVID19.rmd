...
Perhaps most taken for granted is that we have an understanding of how we got to this point, in terms of the introduction, spread, and decline of COVID-19 infections and deaths. 
...
Shockingly, all of these different reporting bureaucracies are not concerned primarily with maintaining a historical time series that can be used to track trends but rather single contemporary measurements. Counts are taken and then disseminated in oral briefings, public websites, pdfs, and even static images. What has resulted is the world's largest most desperate data scavenger hunt. Multiple teams from every country are working in often uncordinated and duplciated efforts to scrape, transcribe, and translate government reporting into consistent panel data covering places over time. In the U.S., the New York Times [@albertsunNewYorkTimes2020] and USAfacts [@usafactsUSCoronavirusCases2020] work to build comprehensive county level counts.

Comparisons across these different collection highlight major discrepancies between the series, [@wangComparingIntegratingUS2020]
