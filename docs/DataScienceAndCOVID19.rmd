...
The SARS-COV-2 global pandemic has exposed weaknesses throughout our institutions, and the sciences are no exception. Given the deluge of official statistics and 300+ new COVID-19 working papers posted each day^[[@COVID19Primer]], it is imperative for both consumers and producers of COVID-19 knowledge to be clear on what we do and do not know. In this brief review, we enumerate ways that data science has highlighted these weaknesses and can help address them.
...
One of the most promising developments is rigorous uniform forecast evaluations [@nicholasgreichReichlabCovid19forecasthubPrepublication2020]. COVID-19 models serve both a short term forecasting role needed for making policy decisions, and also the scientific role of identifying the actual underlying data generating process for long term planning and response. In practice, many forecasting groups have focused almost entirely on the former, constantly tweaking their model to fit recent in-sample data without transparent theoretical justification. Notoriously, many early simple growth models fit to the takeoff period of infections performed well right up until the curve broke and then failed entirely. A parade of predicted peaks in cases since continue the tradition, with groups celebrating success on uninteresting, short-term auto-correlations and ignoring failures on actually interesting unexpected shifts in trends. All we can do is develop a very long memory of predictions and constantly hold models accountable for their out-of-sample performance on unseen future data.
...
In another bad habit common in the social sciences, statistically distinguishable correlations are being pursued for their own sake over attempting to explain variation in COVID-19 outcomes themselves. Papers that can show a particular political party or demographic group is 'worse' on some COVID-19 dimension receive a great deal of effort Despite different arrival times and different rates of testing in rural and poorer areas, a later takeoff date for infections in some states is presented as evidence of incompetence or harmful ideology. Such results lack strong explanatory power, large substantive effects, and clear policy recommendations, and so while they are great for making headlines they do little to help us end the current pandemic.

Perhaps the most egregious trend in recent scholarship is setting up straw man null hypothesis and then presenting the inability to reject them as positive evidence for medical and safety decisions, e.g. social distancing might not be required because a model was unable to statistically distinguish a large uptick in cases following a mass-event. In the best of circumstances, absence of evidence is not evidence of absence. In real world, underfit, undertheorized, underperforming, and poorly measured COVID-19 observational work, our confidence intervals should only be interpreted as optimistic lower bounds of our uncertainty. For the many reasons outlined above, our measurement enterprise can at best distinguish large macro-level trends, not the consequences of individual or brief individual behaviors.
