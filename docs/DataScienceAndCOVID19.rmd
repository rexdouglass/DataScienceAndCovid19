...
The result is an ecosystem of fractured panel datasets, with varying holes in spatial and temporal coverage, and little needed metadata about sources, changes in definitions, and revisions to past counts from reporting sources. Detailed comparisons between 
