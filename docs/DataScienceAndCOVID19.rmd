...
The general failure to track COVID-19 spread directly has led to a proliferation of innovative attempts to use other signals such as web searches, searches of medical databases, social media posts, fevers reported by home thermometer, and traditional flu symptom survailence networks [@koganEarlyWarningApproach2020]. While promising, proxy measures require ground truthing and regular calibration using something like regularly timed serological surveys on smaller geographic sample of the population.
...
The necessity of directly including the test data generating process in models of the epidemiological data generating process can't be understated. Per-capita testing rates are so temporarily correlated with per-capita case rates they are more of a proxy of testing availability than actual cases [@kaashoekCOVID19PositiveCases2020a]. Spatially, per-capita testing rates also correlate with urbanity and co-morbids [@souchCommentaryRuralUrban2020]. How many tests are given and to who varies systematically in response to conditions on the ground with both periods of rationing and blitzes. Worse, because almost any intervention will affect both cases and testing, the treatment effect of even an exogenous intervention is not identified. Estimating an effect requires a combination of sharp constraints on some parameters and informative priors on the relationship between the number of tests and the number of cases [@kubinecRetrospectiveBayesianModel2020].

We do not in general have exogenous assignment of interventions. Governments implemented policies in response to both local conditions and national signals. Populations responded independently of government orders, both reducing their activity prior to being ordered to and also increasing their activity prior to being officially allowed to. Governments, the public, and the disease are all responding simultaneously to each other in often nonlinear and observed ways. Statistical instruments that causes a government intervention but does not cause either testing or cases directly except through the government intervention are few and far between. Further, interventions are often implemented simultaneously or in a rolling cumulative pattern directly in response to changes in cases and testing results, making isolating the effect of any one treatment exceptionally difficult. 

# Evaluation and Interpretation

One of the most promising modeling developments in the early pandemic was the rigorous uniform forecast evaluations [@nicholasgreichReichlabCovid19forecasthubPrepublication2020]. COVID-19 models serve both a short term forecasting role needed for making policy decisions, and also the goal of identifying the actual underlying data generating process for long term planning and response. In practice, many forecasting groups have focused almost entirely on the former, constantly tweaking their model to fit recent in sample data without any clear theoretical or empirical justification. Notoriously, many early simple growth models fit to the early takeoff period of infections performed well right up until the curve broke, and then failed entirely from then on. A parade of predicted peaks in cases since continue the tradition, with groups celebrating success on uninteresting short term auto-correlations and ignoring failures on actually interesting unexpected shifts in trends. The only solution is to have a very long memory and to hold models accountable for their out of sample performance on unseen future data.

Other developments in observational COVID-19 work are mush less promising.^[We omit citations falling under the criticisms provided below as they are working papers and likely to change before finalization.] Metric tons of observational work are presenting correlations as evidence of causation. Without identification, purely correlations results on short highly autocorrelated time series are as likely to be misleading as informative. The SEIR model expects a nonlinear and highly auto-correlated pattern of an increasing infection rate that then levels off independent of any interventions. An analyst could strategically find interventions implemented early that make spread worse, implemented late that make spread better, or somewhere in between with the right time horizon completely independent of the intervention's actual effect. 

In another bad habit common in the social sciences, statistically distinguishable correlations are being pursued for their own sake instead of attempting to explain variation in COVID-19 outcomes. Most prized are papers that can show a particular political party or demographic group is 'worse' on some COVID-19 dimension. Despite different arrival times and different rates of testing in rural and poorer areas, a later takeoff date for infections in some states is presented as evidence of incompetence or harmful ideology. With neither strong explanatory power, large substantive effects, or clearly policy recommendations, these kinds of results are great for making headlines but do little to help us end the current pandemic. 

Perhaps the most unforgivable trend in recent scholarship is setting up straw man null hypothesis and then presenting the inability to reject them as positive evidence for medical and safety decisions, e.g. social distancing might not be required because mass-in-door and mass-out-door events were not immediately followed by a large uptick in cases. If you take away one thing from this review, make it that we do not have sufficient measurement, model development, causal identification, or model performance, to ever present null results as evidence for any health and safety claim on COVID-19. Confidence intervals in this space should be interpreted as the lower bound of uncertainty, not the upper or even the most likely bound for any real world observational research on COVID-19 being presented today.

# Conclusion

This necessarily brief review omitted positive developments in studying COVID-19 outside of macro-observational settings. There has been remarkable progress in areas of diagnosis, clinical treatment, gnomic tracking, and molecular tracking. Data science has contributed to the rapid collaboration, development, and dissemination of research in a way not seen in prior disease outbreaks. Further, our review is overly U.S. centric, with other countries like South Korea monitoring the disease so effectively they succeeded at containment without having to resort to difficult mitigation. We also neglected topics like tracing, and the acompaning contributions from the tech field like mobile phone apps and social media monitoing like Face Book.

We hope we imparted a healthy caution and respect for how little we actually know about the history of this pandemic, and therefore how illpreparaed we are to forcast future developments. Many of these concerns will be deeply familiar to practioners working on these questions and with these data, but others may be either subtle or more prominantly discussed outside one's field of study. At a minimum, there is research being produced today which ignores much of these known methodological problems which is generating confusion for novice consumers of analysis. This enumeration good and band trends in measurement, inference, and evaluation, can serve as a guide for both consumers and producers alike.
