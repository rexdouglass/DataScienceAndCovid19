...
Another bad habit is the pursuit of statistically distinguishable correlations over actually attempting to explain variation in COVID-19 outcomes themselves. Papers that can show a particular political party or demographic group is 'worse' on some COVID-19 dimension receive a great deal of effort. Such results lack strong explanatory power or clear policy recommendations, and so while they are great for making headlines they do little to help us end the current pandemic.
